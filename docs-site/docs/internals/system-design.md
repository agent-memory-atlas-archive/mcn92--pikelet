---
title: System Design
description: A short map of the current Pikelet architecture and where to find the deeper design notes.
sidebar_position: 1
---

# System Design

Pikelet's design is built around one repeated choice: store dense vectors and model weights in compact affine `uint8` layouts, then fuse dequantization with the work that consumes those bytes.
