...
"""Download an official BEIR dataset (corpus/queries/qrels) into benchmarks/beir/cache/.

Usage:
    python3.11 benchmarks/beir/download.py scifact
    python3.11 benchmarks/beir/download.py nfcorpus fiqa arguana trec-covid

Datasets are fetched from the official BEIR release bucket and cached under
benchmarks/beir/cache/<dataset>/ (gitignored — see benchmarks/beir/README.md). Re-running
