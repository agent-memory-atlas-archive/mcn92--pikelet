...
//
// Usage: node benchmarks/beir/encode-pikelet-arctic.mjs <dataset> [--no-prefix]
...
if (!dataset) {
  console.error('usage: node benchmarks/beir/encode-pikelet-arctic.mjs <dataset> [--no-prefix]');
  process.exit(1);
}
