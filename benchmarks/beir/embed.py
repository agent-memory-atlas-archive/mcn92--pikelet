...
Usage:
    python3.11 benchmarks/beir/embed.py scifact corpus
    python3.11 benchmarks/beir/embed.py scifact queries

Reads benchmarks/beir/work/<dataset>/records.jsonl (corpus) or
benchmarks/beir/cache/<dataset>/queries.jsonl (queries), in the exact row order
convert.mjs / the BEIR download already fixed. Writes
benchmarks/beir/work/<dataset>/vectors-<corpus|queries>-float32.f32 (row-major
