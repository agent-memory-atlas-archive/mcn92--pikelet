...
```
node benchmarks/range-proof/failure-modes.mjs [path/to/pack.pikelet]
```
...
```
node benchmarks/range-proof/mcp-proof.mjs [path/to/pack.pikelet]
```
...
`benchmarks/beir/` for retrieval-quality measurement. This only demonstrates
