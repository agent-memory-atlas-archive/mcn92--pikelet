...
const RESULTS_DIR = path.join(ROOT_DIR, 'results', 'raw');
const RELEASE_RESULTS_DIR = path.join(ROOT_DIR, 'results');
...
function printUsage() {
  console.log('Usage: node benchmarks/engine/run.js <benchmark> [benchmark args]');
  console.log('');
  console.log('Examples:');
  console.log('  node benchmarks/engine/run.js benchmark_nytimes --m 12 --ef-construction 100 --ef-search 200');
  console.log('  node benchmarks/engine/run.js benchmark_sift1m --m 24 --ef-construction 300 --ef-search 150 /path/to/sift');
  console.log('  node benchmarks/engine/run.js --list');
  console.log('');
