 ...
 *
 * Usage:
 *   node benchmarks/engine/range_cluster_page_sim.js \
 *     --artifact benchmarks/results/raw/layout/pancake-sift1m-u8-metis-split.pikelet-range \
 *     --partition benchmarks/results/raw/layout/pancake-sift1m-base.metis.part.5036 \
...
async function main() {
  const artifactPath = arg('artifact', 'benchmarks/results/raw/layout/pancake-sift1m-u8-metis-split.pikelet-range');
  const partitionPath = arg('partition', 'benchmarks/results/raw/layout/pancake-sift1m-base.metis.part.5036');
