 ...
 *
 * Usage:
 *   node benchmarks/engine/benchmark_synthetic_1536.js
 *   node benchmarks/engine/benchmark_synthetic_1536.js --regenerate-gt
 */
...
const CACHE_DIR = path.join(__dirname, '..', 'results', 'raw', 'cache');
