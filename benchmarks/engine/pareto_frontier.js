 ...
 *
 * Usage:
 *   node benchmarks/engine/pareto_frontier.js --dataset dbpedia
 *   node benchmarks/engine/pareto_frontier.js --dataset sift
 *   node benchmarks/engine/pareto_frontier.js --dataset nytimes
 *   node benchmarks/engine/pareto_frontier.js --dataset glove
 *   node benchmarks/engine/pareto_frontier.js --dataset mnist
 *   node benchmarks/engine/pareto_frontier.js --dataset custom --base-file base.fvecs --query-file query.fvecs --metric l2
 *   node benchmarks/engine/pareto_frontier.js --dataset custom --hdf5-file glove-100-angular.hdf5 --metric cosine
 *   node benchmarks/engine/pareto_frontier.js --dataset dbpedia --data-dir ./dbpedia
 *   node benchmarks/engine/pareto_frontier.js --count 50000
 *   node benchmarks/engine/pareto_frontier.js --ef-search-values 10,50,100,200
 *   node benchmarks/engine/pareto_frontier.js --regenerate-gt
 *   node benchmarks/engine/pareto_frontier.js --dataset nytimes --zero-vector-policy fail
 *   node benchmarks/engine/pareto_frontier.js --dataset nytimes --library pikelet
 *   node benchmarks/engine/pareto_frontier.js --dataset nytimes --configs pikelet-wasm-u8,pikelet-wasm-fp32
 */
...
// --- Output paths ---
const RESULTS_DIR = path.resolve(getStrArg('output-dir', path.join(__dirname, '..', 'results', 'raw')));
